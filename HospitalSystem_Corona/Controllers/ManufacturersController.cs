...
namespace HospitalSystem_Corona.Controllers
{
    public class ManufacturersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "manufacturar_id,name")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
                var existsManufacturar = db.Manufacturer.FirstOrDefault(m => m.name == manufacturer.name);
                if (existsManufacturar == null)
                {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "manufacturar_id,name")] Manufacturer manufacturer)
        {
            if (ModelState.IsValid)
            {
